  ...
  return (
    <div className='w-full min-h-screen flex items-center justify-center'>
      <div className='w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4'>
        ...
        <div className='group flex justify-center items-center flex-col border-2 border-dotted border-gray-300 w-full h-200 md:h-420 cursor-pointer rounded-lg'>
          { isLoading ? <Loader /> : <>
            { !imageAsset ? <>
              ...
              <div className='relative h-full'>
                <img src={imageAsset} alt="uploded_image" className='w-full h-full object-cover' />
